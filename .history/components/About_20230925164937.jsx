...
const About = () => {
  return (
    <div id className='w-full md:h-screen p-3  flex items-center py-16'>
        <div className='max-w-[1240] m-auto md:grid grid-cols-3 gap-8'>
          ...
          <p className='uppercase text-gray-600 py-2 underline cursor-pointer'>Check out of my some latest project</p>
    </div>
            <div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
              <img className='rounded-xl' src='https://a.ilovecoding.org/thumb/api2-2-crud.png' alt='/' />
            </div>
        </div>
    </div>
  )
