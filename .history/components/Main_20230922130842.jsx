...
<h1 className='py-4 text-gray-700'>
        ...
        <div className='flex items-center justify-center max-w-[300px] m-auto py-4'>
<div className='rounded-full shadow-lg shadow-gray-400 p-6 gap gap-4 cursor-pointer hover:scale-105 ease-in duration-300'>
  <FaLinkedinIn />
</div>
