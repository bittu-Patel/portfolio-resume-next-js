...
import crudkImg from '../public/assets/skills/blog.png';
...
<div className='absolute top-0 left-0 w-full h-[50vh] bg-black/70 z-10' />
  ...
  <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
    <h2 className='py-2'>crudk Crud</h2>
    <h3>Next.JS / Tailwind Css /Api /prisma </h3>
  </div>
</div>
...
<p>Project</p>
<h2>Overview</h2>
<p>This project is a full-stack web application built using Next.js, a React framework, and Tailwind CSS for styling. It encompasses both the frontend and backend components to create a dynamic and interactive user experience.</p>
