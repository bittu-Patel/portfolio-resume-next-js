        ...
        <div className='py-6'>
          ...
          <ul className='list-disc list-outside px-7 py-1 leading-relaxed'>
            ...
            The opener&#39;s role often extends beyond individual performance.
             They are expected to form a strong opening partnership with their fellow batsman. This partnership sets the platform for the middle order to build upon.
            </li>
            <li>
