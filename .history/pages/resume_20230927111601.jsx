      ...
      <div className='max-w-[940px] mx-auto p-2 pt-[120px]'>
        ...
        <div className='py-6'>
          ...
          <ul className='list-disc list-outside px-7 py-1 leading-relaxed'>
            ...
            <li>
            This involves creating the user interface and user experience (UI/UX) of a website. It encompasses HTML, CSS, JavaScript, and various libraries and frameworks like React, Angular, or Vue.js.
            </li>
          </ul>
        </div>
