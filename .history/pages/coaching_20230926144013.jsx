...
import coImg from '../public/assets/skills/co.png';
...
<div className='absolute top-0 left-0 w-full h-[50vh] bg-black/70 z-10' />
  ...
  <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
    <h2 className='py-2'>co Toolkit</h2>
    <h3>Next.JS</h3>
  </div>
</div>
...
<p>Project</p>
<h2>Overview</h2>
<p>co Toolkit is a library that simplifies and streamlines the process of managing state in a React application.
   ...
   <div className='grid grid-cols-3 md:grid-cols-1'>
    ...
    <p className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill className='pr-1' />co</p>
   </div>
    </div>
   </div>
   <Link href='/#projects'>
